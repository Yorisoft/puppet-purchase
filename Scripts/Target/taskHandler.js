...
async function logIn(page) {
    ...
    signingText = await page.$eval('span.styles__AccountName-sc-1kk0q5l-0.hVhJPq', (el) => { return el.innerText });
...
async function findListing(page) {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        stocks = await page.$eval(utils.selectors.get('outOfStock_selector'), (element) => { return element.innerHTML });
